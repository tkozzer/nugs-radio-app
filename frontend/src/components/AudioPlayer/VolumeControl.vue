<template>
  <div class="volume-control relative" :class="{ 'dark': isDarkMode }">
    ...
    <div v-if="showVolumeSlider" class="volume-slider absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-white dark:bg-gray-800 p-2 rounded shadow-md">
      <input
        type="range"
        min="0"
        max="1"
